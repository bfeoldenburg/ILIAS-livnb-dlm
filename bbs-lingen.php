...
//	require_once "./include/inc.header.php";
	...
	$cid = "R33908"; //BBS-Lingen
	$userCnt = 25;
	$userNamePrefix = "BBS-Lingen-User";
	$ufn = "BBS-Lingen";
	$ulnp = "Benutzer ";
	$pwd = "ilias-livz";
	$howmanydays = 0;
...
Kurs "Berufsbildende Schulen Lingen"<br>
Benutzerverwaltung</legend>

		<div><h4>Auf dieser Seite können die Benutzer User1 bis User25 neu angelegt werden.<br/>Achtung: Alle vorhandenen Lernstände und Verknüpfungen zum Persönlichen Schreibtisch gehen dabei verloren!</h4></div>
		<div><br/></div>
