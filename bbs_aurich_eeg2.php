...
//	require_once "./include/inc.header.php";
	...
	$cid = "R41105"; //BBS Aurich EEG2
	$userCnt = 25;
	$userNamePrefix = "EEG2-User";
	$ufn = "BBS Aurich";
	$ulnp = "EEG2 ";
	$pwd = "ilias-liv";
	$howmanydays = 0;
...
Kurs "BBS Aurich - EEG2"<br>
Benutzerverwaltung</legend>

		<div><h4>Auf dieser Seite können die Benutzer EEG2-User1 bis EEG2-User25 neu angelegt werden.<br/>Achtung: Alle vorhandenen Lernstände und Verknüpfungen zum Persönlichen Schreibtisch gehen dabei verloren!</h4></div>
		<div><br/></div>
