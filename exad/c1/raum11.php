...
<div class="container">
	<form action="" class="form-horizontal" method="post" role="form">
		<legend>KHS-OL Raum 11 - Benutzerverwaltung</legend>

		<div><h4>Auf dieser Seite können die Benutzer User1 bis User12 für Raum11 neu angelegt werden.<br/>Achtung: Alle vorhandenen Lernstände und Verknüpfungen zum Persönlichen Schreibtisch gehen dabei verloren!</h4></div>
		<div><br/></div>
