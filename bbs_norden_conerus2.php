...
//	require_once "./include/inc.header.php";
	...
	$cid = "R42343"; //BBS Norden Conerus-Schule
	$userCnt = 25;
	$userNamePrefix = "user-BFE";
	$ufn = "BBS Norden";
	$ulnp = "BFE User ";
	$pwd = "ilias-liv";
	$howmanydays = 0;
...
Kurs "BBS Norden Conerus-Schule"<br>
Benutzerverwaltung</legend>

		<div><h4>Auf dieser Seite können die Benutzer user-BFE1 bis user-BFE25 neu angelegt werden.<br/>Achtung: Alle vorhandenen Lernstände und Verknüpfungen zum Persönlichen Schreibtisch gehen dabei verloren!</h4></div>
		<div><br/></div>
