...
//	require_once "./include/inc.header.php";
	...
	$cid = "R40940"; //Kreishandwerkerschaft Wesermarsch
	$userCnt = 12;
	$userNamePrefix = "wesermarsch-user";
	$ufn = "Wesermarsch";
	$ulnp = "Benutzer ";
	$pwd = "ilias-liv";
	$howmanydays = 0;
...
Kurs "Kreishandwerkerschaft Wesermarsch"<br>
Benutzerverwaltung</legend>

		<div><h4>Auf dieser Seite können die Benutzer wesermarsch-user1 bis wesermarsch-user12 neu angelegt werden.<br/>Achtung: Alle vorhandenen Lernstände und Verknüpfungen zum Persönlichen Schreibtisch gehen dabei verloren!</h4></div>
		<div><br/></div>
