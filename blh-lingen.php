...
//	require_once "./include/inc.header.php";
	...
	$cid = "R34788"; //Bildungswerk des Lingener Handwerks e.V.
	$userCnt = 16;
	$userNamePrefix = "BLH-Lerner";
	$ufn = "Bildungswerk-Lingen";
	$ulnp = "Lerner ";
	$pwd = "ilias-livz";
	$howmanydays = 0;
...
Kurs "Bildungswerk des Lingener Handwerks e. V."<br>
Benutzerverwaltung</legend>

		<div><h4>Auf dieser Seite können die Benutzer BLH-Lerner1 bis BLH-Lerner16 neu angelegt werden.<br/>Achtung: Alle vorhandenen Lernstände und Verknüpfungen zum Persönlichen Schreibtisch gehen dabei verloren!</h4></div>
		<div><br/></div>
