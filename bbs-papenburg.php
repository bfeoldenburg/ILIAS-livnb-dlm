...
//	require_once "./include/inc.header.php";
	...
	$cid = "R40444"; //Berufsbildende Schulen Papenburg
	$userCnt = 55;
	$userNamePrefix = "BBSP-Lerner";
	$ufn = "BBS-Papenburg";
	$ulnp = "Lerner ";
	$pwd = "ilias-livz";
	$howmanydays = 0;
...
Kurs "Berufsbildende Schulen Papenburg"<br>
Benutzerverwaltung</legend>

		<div><h4>Auf dieser Seite können die Benutzer BBSP-Lerner1 bis BBSP-Lerner55 neu angelegt werden.<br/>Achtung: Alle vorhandenen Lernstände und Verknüpfungen zum Persönlichen Schreibtisch gehen dabei verloren!</h4></div>
		<div><br/></div>
