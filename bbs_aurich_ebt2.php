...
//	require_once "./include/inc.header.php";
	...
	$cid = "R41082"; //BBS Aurich EBT2
	$userCnt = 25;
	$userNamePrefix = "EBT2-User";
	$ufn = "BBS Aurich";
	$ulnp = "EBT2 ";
	$pwd = "ilias-liv";
	$howmanydays = 0;
...
Kurs "BBS Aurich - EBT2"<br>
Benutzerverwaltung</legend>

		<div><h4>Auf dieser Seite können die Benutzer EBT2-User1 bis EBT2-User25 neu angelegt werden.<br/>Achtung: Alle vorhandenen Lernstände und Verknüpfungen zum Persönlichen Schreibtisch gehen dabei verloren!</h4></div>
		<div><br/></div>
